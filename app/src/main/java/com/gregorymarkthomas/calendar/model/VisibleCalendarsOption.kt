...
class VisibleCalendarsOption(preferences: GetSharedPreferencesInterface) {
    ...
    /**
     * We can change this to a theoretical "StringDatabaseOptionData" instance if we would prefer to store this option in database instead of SharedPreferences.
     */
    private val option: Option.StringOption = StringSharedPreferenceOptionData(preferences, "visible_calendars_key", "")
