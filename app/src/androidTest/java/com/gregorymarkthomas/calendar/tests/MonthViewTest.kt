...
class MonthViewTest {
    ...
    @get:Rule
    val writePermissionRule = GrantPermissionRule.grant(Manifest.permission.WRITE_CALENDAR)

    @get:Rule
    val readPermissionRule = GrantPermissionRule.grant(Manifest.permission.READ_CALENDAR)
